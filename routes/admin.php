    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::controller(SettingsController::class)
            ...
            ->group(function () {
                ...
                // Candidate Update
                Route::put('candidate/update', 'candidateSettingsUpdate')->name('candidate.update');
        ...
        Route::resource('cupon', CouponController::class)->names('cupon');
        Route::post('/cupon/bulk/delete', [CouponController::class, 'bulkDelete'])->name('cupon.bulk.delete');
        Route::post('/cupon/bulk/status', [CouponController::class, 'bulkStatus'])->name('cupon.status.change');
