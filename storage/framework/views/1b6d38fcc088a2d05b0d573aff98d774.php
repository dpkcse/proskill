...
<script defer src="<?php echo e(asset('frontend/assets/js/bootstrap.bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/jquery.counterup.min.js')); ?>"></script>
<script async src="<?php echo e(asset('frontend/assets/js/jquery.scrollUp.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/scrollax.min.js')); ?>"></script>
<script async src="<?php echo e(asset('backend/plugins/select2/js/select2.min.js')); ?>"></script>
<script src="<?php echo e(asset('frontend/assets/js/waypoints.min.js')); ?>"></script>
<script async src="<?php echo e(asset('backend/plugins/toastr/toastr.min.js')); ?>"></script>
<script async src="<?php echo e(asset('backend/plugins/sweetalert2/sweetalert2.all.min.js')); ?>"></script>
...
<?php echo app('Illuminate\Foundation\Vite')(['resources/frontend/js/app.js', 'resources/frontend/js/public.js']); ?>
...
<script>
    ...
    if (auth_check == 1) {
        ...
        function loadUnreadMessageCount() {
            $.ajax({
                url: "<?php echo e(route('load.unread.count')); ?>",
                type: "GET",
...
<?php echo $__env->yieldPushContent('frontend_scripts'); ?>
<?php echo $__env->yieldContent('frontend_scripts'); ?>

<script>
    function initToaster(){
        <?php if(request('verified')): ?>
            Swal.fire({
                title: "<?php echo e(__('email_verified')); ?>",
                text: "<?php echo e(__('your_email_has_been_verified')); ?>",
                icon: "success",
            })
        <?php endif; ?>
    ...
    function ReadNotification() {
        $.ajax({
            url: "<?php echo e(route('user.notification.read')); ?>",
            type: "POST",
            data: {
    ...
    function readSingleNotification(url, id) {
        $.ajax({
            url: "<?php echo e(route('website.markread.notification')); ?>",
            type: "POST",
            data: {
                id: id,
                _token: '<?php echo e(csrf_token()); ?>'
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.login_required', function(event) {
            ...
            Swal.fire({
                title: "<?php echo e(__('unauthenticated')); ?>",
                text: "<?php echo e(__('if_you_perform_this_action_you_need_to_login_your_account_first_do_you_want_to_login_now')); ?>",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: "<?php echo e(__('yes_want_to_login')); ?>",
        ...
        $('.no_permission').on('click', function(event) {
            event.preventDefault();
            Swal.fire({
                title: "<?php echo e(__('unauthorized_access')); ?>",
                text: "<?php echo __('you_dont_have_permission_to_perform_this_action'); ?>",
                icon: "warning",
                dangerMode: true,
            })
        });
        ...
        function updateFormAction(selectedRadioValue) {
            ...
            const actionUrl = selectedRadioValue ?
                "<?php echo e(route('website.job.category.slug', ':slug')); ?>".replace(':slug', dataSlug) :
                defaultAction;
            form.attr("action", actionUrl);
        }

        // Initialize form action on page load
        updateFormAction("<?php echo e(Route::current()->parameter('category')); ?>");
...
<?php /**PATH /Volumes/OFFICIAL/DEVSFLOCK/Proskill Job/localproskill/resources/views/frontend/partials/public-scripts.blade.php ENDPATH**/ ?>