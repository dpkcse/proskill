...
<head>
    ...
    <title><?php echo e(__('sign_in')); ?> | <?php echo e(config('app.name')); ?></title>
    ...
    <?php echo $__env->yieldContent('backend_auth_link'); ?>
</head>
...
<body>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-5">
                <div class="d-flex flex-column justify-content-between align-items-center py-5 px-4 min-vh-100">
                    <a href="<?php echo e(route('admin.login')); ?>" class="d-block">
                        <div class="system-logo d-flex justify-content-center">
                            <img src="<?php echo e($setting->dark_logo_url); ?>" alt="<?php echo e(__('logo')); ?>" class="img-fluid">
                        </div>
                    </a>
    ...
    <?php echo $__env->yieldContent('backend_auth_script'); ?>
...
<?php /**PATH /Volumes/OFFICIAL/DEVSFLOCK/Proskill Job/localproskill/resources/views/backend/layouts/auth.blade.php ENDPATH**/ ?>