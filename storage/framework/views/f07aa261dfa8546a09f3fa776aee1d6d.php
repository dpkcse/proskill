            ...
            <div class="row">
                <div class="col-lg-4 col-md-5 col-sm-6 rt-single-widget ">
                    <a href="#" class="footer-logo">
                        <img src="<?php echo e($setting->light_logo_url); ?>" alt="logo" loading="lazy">
                    </a>
                    <address>
                            ...
                            <div class="max-312 body-font-4 mt-2 text-gray-500">
                                ...
                                <div class="body-font-4 mt-3 text-gray-500">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div>
                                            <span class="text-gray-10 fw-medium"><?php echo e(__('address')); ?>: <?php echo e(__('footer_address')); ?></span>
                                        </div>
                                    </div>
                                </div>
                        </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 rt-single-widget ">
                    ...
                    <ul class="rt-usefulllinks2">
                        ...
                        <?php if(moduleActive('CandidatePlan')): ?>
                        <?php if($hasActiveCandidatePlan): ?>
                        <li><a href="<?php echo e(route('candidate.plan')); ?>"><?php echo e(__('candidate_plan')); ?></a></li>
                        <?php endif; ?>
                        <?php endif; ?>
...
<?php $component = App\View\Components\Website\FooterCopyright::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('website.footer-copyright'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\Website\FooterCopyright::ignoredParameterNames()); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.svg.new-twitter-icon','data' => ['width' => '20','height' => '20','fill' => '#727279']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['width' => '20','height' => '20','fill' => '#727279']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <?php endif; ?>
                        <?php if($cms_setting?->footer_linkedin_link): ?>
                            <li>
                                <a href="<?php echo e($cms_setting->footer_linkedin_link); ?>" title="LinkedIn">
                        ...
                        <?php endif; ?>
                        <?php if($cms_setting?->footer_pinterest_link): ?>
                            <li>
                                <a href="<?php echo e($cms_setting->footer_pinterest_link); ?>" title="Pinterest">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <?php endif; ?>
                        <?php if($cms_setting?->footer_tiktok_link): ?>
                            <li>
                                <a href="<?php echo e($cms_setting->footer_tiktok_link); ?>" title="TikTok">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <?php endif; ?>
                        <?php if($cms_setting?->footer_whatsapp_link): ?>
                            <li>
                                <a href="<?php echo e($cms_setting->footer_whatsapp_link); ?>" title="WhatsApp">
...
<?php /**PATH /Volumes/OFFICIAL/DEVSFLOCK/Proskill Job/localproskill/resources/views/frontend/partials/footer.blade.php ENDPATH**/ ?>