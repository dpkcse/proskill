...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function candidatePlan(): HasOne
    {
        return $this->hasOne(CandidateUserPlan::class, 'user_id');
    }

    /**
     * Override the default email verification notification
     * to prevent Laravel's built-in VerifyEmail notification from being sent
     * since we're using our custom EmailVerifyNotification
     */
    public function sendEmailVerificationNotification()
    {
        // Do nothing - we handle email verification manually with our custom notification
        // This prevents Laravel's built-in VerifyEmail notification from being sent
    }
}
