                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    <div class="tab-pane fade show active" id="home" role="tabpanel"
                                                        ...
                                                        <div class="social-links">
                                                            ...
                                                            <div class="social-media">
                                                                <ul>
                                                                    <li v-if="candidate.social_info && candidate.social_info[0]">
                                                                        <a :href="candidate.social_info && candidate.social_info[0]['url']"
                                                                    ...
                                                                    <li v-if="candidate.social_info && candidate.social_info[1]">
                                                                        <a :href="candidate.social_info && candidate.social_info[1]['url']"
                                                                            class="bg-primary-50 text-primary-500 plain-button tw-inline-flex tw-justify-center tw-items-center tw-rounded !tw-w-10 !tw-h-10 hover:bg-primary-500 hover:text-primary-50">
                                                                            <svg width="20" height="20"
                                                                                viewBox="0 0 20 20" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <li v-if="candidate.social_info && candidate.social_info[2]">
                                                                        <a :href="candidate.social_info && candidate.social_info[2]['url']"
                                                                            class="bg-primary-50 text-primary-500 plain-button tw-inline-flex tw-justify-center tw-items-center tw-rounded !tw-w-10 !tw-h-10 hover:bg-primary-500 hover:text-primary-50">
                                                                            <svg width="20" height="20"
                                                                                viewBox="0 0 20 20" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <li v-if="candidate.social_info && candidate.social_info[3]">
                                                                        <a :href="candidate.social_info && candidate.social_info[3]['url']"
                                                                            class="bg-primary-50 text-primary-500 plain-button tw-inline-flex tw-justify-center tw-items-center tw-rounded !tw-w-10 !tw-h-10 hover:bg-primary-500 hover:text-primary-50">
                                                                            <svg width="20" height="20"
                                                                                viewBox="0 0 20 20" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <li v-if="candidate.social_info && candidate.social_info[4]">
                                                                        <a :href="candidate.social_info && candidate.social_info[4]['url']"
                                                                            class="bg-primary-50 text-primary-500 plain-button tw-inline-flex tw-justify-center tw-items-center tw-rounded !tw-w-10 !tw-h-10 hover:bg-primary-500 hover:text-primary-50">
                                                                            <svg width="20" height="20"
                                                                                viewBox="0 0 20 20" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                                                                    ...
                                                                    <li v-if="candidate.social_info && candidate.social_info[5]">
                                                                        <a :href="candidate.social_info && candidate.social_info[5]['url']"
                                                                            class="bg-primary-50 text-primary-500 plain-button tw-inline-flex tw-justify-center tw-items-center tw-rounded !tw-w-10 !tw-h-10 hover:bg-primary-500 hover:text-primary-50">
                                                                            <svg width="20" height="20"
                                                                                viewBox="0 0 20 20" fill="none"
                                                                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="sidebar-widget">
                                    <div v-if="settings.candidate_birth_date_active" class="row">
                                        <div class="col-md-6">
                                            <div class="icon-box">
                                                <div class="icon-img">
                                    ...
                                    <div v-if="settings.candidate_marital_status_active || settings.candidate_gender_active" class="row">
                                        <div v-if="settings.candidate_marital_status_active" class="col-md-6">
                                            <div class="icon-box">
                                                <div class="icon-img">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div v-if="settings.candidate_gender_active" class="col-md-6">
                                            <div class="icon-box">
                                                <div class="icon-img">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
    ...
    export default {
        ...
        data() {
            return {
                ...
                msgloading: false,
                settings: {
                    candidate_birth_date_active: true,
                    candidate_marital_status_active: true,
                    candidate_gender_active: true
                }
            }
        },
        methods: {
