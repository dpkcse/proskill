                ...
                <div class="rt-single-icon-box tw-flex-wrap tw-gap-4">
                    ...
                    <div class="iconbox-content">
                        ...
                        @if ($job->job_start && $job->job_end)
                            <span class="tw-block tw-mt-1 tw-text-xs tw-text-[#767F8C]">
                                {{ __('Du') }} {{ \Carbon\Carbon::parse($job->job_start)->format('d/m/Y') }} {{ __('au') }} {{ \Carbon\Carbon::parse($job->job_end)->format('d/m/Y') }}
                            </span>
                        @endif
                    </div>
                </div>
