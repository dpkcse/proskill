                                            ...
                                            @if ($applied_job->status == 'active' || $applied_job->status == 'pending')
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <form action="{{ route('admin.job.status.change', $applied_job->id) }}"
                                                        ...
                                                        <label class="custom-control-label"
                                                            for="status_input_publish_{{ $applied_job->id }}">{{ __('published') }}</label>
                                                    </form>
                                                </div>
                                            @endif
                                        </div>
                                ...
                                <div class="candidate-details__right">
                                    ...
                                    <div class="three">
                                        ...
                                        <div>
                                            ...
                                            <p>{{ __('job_start') }}</p>
                                            <h4>{{ $applied_job->job_start ? date('D, d M Y', strtotime($applied_job->job_start)) : '-' }}</h4>
                                        </div>
                                        <div>
                                            <x-svg.details-calendar-blank />
                                            <p>{{ __('job_end') }}</p>
                                            <h4>{{ $applied_job->job_end ? date('D, d M Y', strtotime($applied_job->job_end)) : '-' }}</h4>
                                        </div>
                                        <div>
                                            <x-svg.details-calendar-blank />
                                            <p>{{ __('deadline') }}</p>
