            ...
            <div class="row">
                        ...
                        <div class="section pt-3" id="job-details">
                            <div class="card mb-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <x-forms.label name="category" for="category_id" :required="true" />
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            <x-forms.label name="profession" for="profession_id" :required="true" />
                                            <select name="profession_id"
                                                class="form-control select2bs4 @error('profession_id') is-invalid @enderror"
                                                id="profession_id" required>
                                                <option value="">{{ __('choose_profession') }}</option>
                                                @foreach ($professions as $profession)
                                                    <option {{ old('profession_id', $job->profession_id) == $profession->id ? 'selected' : '' }} value="{{ $profession->id }}">{{ $profession->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('profession_id')
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <input id="deadline" type="text" name="deadline" placeholder="{{ __('dd_mm_yyyy') }}"
                                    ...
                                    <div class="row form-group">
                                        <div class="col-12">
                                            <x-forms.label name="{!! __('job_start_end_title') !!}" for="job_period" :required="false" />
                                            <input id="job_period" type="text" name="job_period"
                                                ...
                                                value="{{ old('job_start', $job->job_start) && old('job_end', $job->job_end) ? old('job_start', $job->job_start) . ' - ' . old('job_end', $job->job_end) : '' }}" readonly autocomplete="off">
                                            <input type="hidden" id="job_start" name="job_start" value="{{ old('job_start', $job->job_start) }}">
                                            <input type="hidden" id="job_end" name="job_end" value="{{ old('job_end', $job->job_end) }}">
                                            @error('job_start')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ __($message) }}</strong>
                                                </span>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12 mb-2">
                                            <x-forms.label name="tags" for="tags" :required="false" />
                                            <select name="tags[]"
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <x-forms.label name="benefits" for="benefits" :required="false" />
                                        ...
                                        <div class="col-md-12">
                                            <x-forms.label name="skills" for="skill" :required="false" />
                                            <select name="skills[]"
                ...
                <div class="col-md-4 pt-3">
                    <div class="card tc-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-4">{{ __('job_information') }}</h5>
                            <div class="tc-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#job-details" class="step-menu active">{{ __('job_details') }}</a>
                                    </li>
                                    <li>
                                        <a href="#location" class="step-menu">{{ __('location') }}</a>
                                    </li>
                                    <li>
                                        <a href="#salary-details" class="step-menu">{{ __('salary_details') }}</a>
                                    </li>
                                    <li>
                                        <a href="#attributes" class="step-menu">{{ __('attributes') }}</a>
                                    </li>
                                    <li>
                                        <a href="#applicant-options" class="step-menu">{{ __('applicant_options') }}</a>
                                    </li>
                                    <li>
                                        <a href="#promote" class="step-menu">{{ __('promote') }}</a>
                                    </li>
                                    <li>
                                        <a href="#description" class="step-menu">{{ __('description') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Cache the options for restoration
            var $onOurPlatformOption = $('#apply_on option[value="app"]');
            function toggleApplyOptions() {
                // Remove options if checked
                if ($('#just_name').is(':checked')) {
                    $onOurPlatformOption.detach();
                    console.log('Email and custom URL options are now HIDDEN.');
                } else {
                    // Restore options if not present
                    if ($('#apply_on option[value="email"]').length === 0) {
                        $('#apply_on').append($emailOption);
                    }
                    if ($('#apply_on option[value="custom_url"]').length === 0) {
                        $('#apply_on').append($customUrlOption);
                    }
                    if ($('#apply_on option[value="app"]').length === 0) {
                        $('#apply_on').append($onOurPlatformOption);
                    }

                    console.log('Email and custom URL options are now SHOWN.');
                }
            }
