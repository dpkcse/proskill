                                    ...
                                    <div class="row form-group">
                                        <div class="col-12">
                                            ...
                                            <input id="job_period" type="text" name="job_period"
                                                ...
                                                value="{{ old('job_start') && old('job_end') ? old('job_start') . ' - ' . old('job_end') : '' }}" readonly autocomplete="off">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-sm-12 col-md-12">
                                            ...
                                            <select name="apply_on"
                                                ...
                                                <option {{ old('apply_on') ? '' : 'selected' }} value="on_our_platform"
                                                    class="d-none" id="on_our_platform">
