                ...
                <div class="d-flex flex-wrap  tw-gap-2 tw-items-center">
                    <div class="n-header--bottom__left d-flex align-items-center menu-header">
                        ...
                        <div class="container">
                            <ul class="menu-active-classes">
                                ...
                                <li class="menu-item">
                                    ...
                                    'https://']);
                                    @endphp
                                    <a href="{{ $company_menu_list['url'] }}" @if ($isExternalLink) target="_blank"
                                        @endif
                                ...
                                @foreach ($custom_pages->where('show_header', 1) as $page)
                                <li class="d-lg-none">
                                    <a class="" href="{{ $page->slug }}">{{ $page->title }}</a>
                                </li>
                                @endforeach
                                @endif
                            </ul>
                        ...
                        <div class="container">
                            <ul class="menu-active-classes ">
                                ...
                                <li class="menu-item">
                                    ...
                                    'https://']);
                                    @endphp
                                    <a href="{{ $candidate_menu_list['url'] }}" @if ($isExternalLink) target="_blank"
                                        @endif
                        ...
                        <div class="container">
                            <ul class="menu-active-classes">
                                ...
                                <li class="menu-item">
                                    ...
                                    'https://']);
                                    @endphp
                                    <a href="{{ $public_menu_list['url'] }}" @if ($isExternalLink) target="_blank"
                                        @endif
                        ...
                        <form action="{{ $form_action }}" method="GET" id="search-form"
                            class="mx-width-300 header-search-form d-none">
                    ...
                    <div class="n-header--bottom__right">
                        <div class="d-flex align-items-center ">
                            <div class="search-icon tw-ml-2 !tw-cursor-pointer">
                                <span>
