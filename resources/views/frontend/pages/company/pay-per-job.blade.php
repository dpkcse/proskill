                        ...
                        <form action="{{ route('company.payperjob.store') }}" method="POST" class="rt-from">
                            ...
                            <div class="post-job-item rt-mb-15">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 rt-mb-20 col-md-4">
                                        ...
                                        <select class="w-100-p select2-taggable select2-search form-control @error('profession_id') is-invalid @enderror" name="profession_id">
                            ...
                            <div class="post-job-item rt-mb-15">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 rt-mb-20">
                                        <x-forms.label name="job_start" :required="false" class="tw-text-sm tw-mb-2" />
                                        <div class="fromGroup">
                                            <div class="form-control-icon date datepicker">
                                                <input value="{{ old('job_start') }}" name="job_start"
                                                    class="form-control @error('job_start') is-invalid @enderror"
                                                    type="text" id="job_start" placeholder="{{ __('dd-mm-yyyy') }}">
                                                <span class="input-group-addon has-badge">
                                                    <span @error('job_start') rt-mr-12 @enderror>
                                                        <x-svg.calendar-icon />
                                                    </span>
                                                </span>
                                                @error('job_start')
                                    ...
                                    <div class="col-lg-6 col-md-6 rt-mb-20">
                                        <x-forms.label name="job_end" :required="false" class="tw-text-sm tw-mb-2" />
                                        <div class="fromGroup">
                                            <div class="form-control-icon date datepicker">
                                                <input value="{{ old('job_end') }}" name="job_end"
                                                    class="form-control @error('job_end') is-invalid @enderror"
                                                    type="text" id="job_end" placeholder="{{ __('dd-mm-yyyy') }}">
                                                <span class="input-group-addon has-badge">
                                                    <span @error('job_end') rt-mr-12 @enderror>
                                                        <x-svg.calendar-icon />
                                                    </span>
                                                </span>
                                                @error('job_end')
                                ...
                                <div x-data="appQuestion()" x-init="select2Alpine"
                                    ...
                                    <div x-show="isAddingNewQuestion == false" class="q-select">
                                        <select id="questionSelect" multiple="multiple" x-ref="select"
                                            data-placeholder="{{ __('select_questions') }}" name="companyQuestions[]" class="">
                                            <option></option>
...
@endsection
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Easepick for job start
            const jobStartPicker = new easepick.create({
                element: document.getElementById('job_start'),
                css: [
                    'https://cdn.jsdelivr.net/npm/@easepick/bundle@1.2.1/dist/index.css',
                ],
                format: 'DD-MM-YYYY',
                ...
                setup(picker) {
                    picker.on('select', (e) => {
                        const date = picker.getDate();
                        document.getElementById('job_start').value = date ? date.format('DD-MM-YYYY') : '';
                    });
                }
            });

            // Easepick for job end
            const jobEndPicker = new easepick.create({
                element: document.getElementById('job_end'),
                css: [
                    'https://cdn.jsdelivr.net/npm/@easepick/bundle@1.2.1/dist/index.css',
                ],
                format: 'DD-MM-YYYY',
                ...
                setup(picker) {
                    picker.on('select', (e) => {
                        const date = picker.getDate();
                        document.getElementById('job_end').value = date ? date.format('DD-MM-YYYY') : '';
                    });
                }
            });
            ...
            document.querySelectorAll('.input-group-addon').forEach(function(addon) {
                addon.addEventListener('click', function() {
                    ...
                    const jobStartInput = this.closest('.form-control-icon').querySelector('#job_start');
                    const jobEndInput = this.closest('.form-control-icon').querySelector('#job_end');
                    
                    if (dateInput) {
                        deadlinePicker.show();
                    } else if (jobStartInput) {
                        jobStartPicker.show();
                    } else if (jobEndInput) {
                        jobEndPicker.show();
                    }
